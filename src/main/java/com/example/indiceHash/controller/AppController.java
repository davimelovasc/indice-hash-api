...
public class AppController {
	...
	public ResponseEntity<Tabela> getTable(@PathVariable(name = "table_name") String tableName) {
		return new ResponseEntity<>(appService.getTable(tableName), HttpStatus.OK);
	}
